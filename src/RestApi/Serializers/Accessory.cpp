...
{
    boost::json::object AccessorySerializer::ToJson(const Common::Accessory &accessory)
    {
    ...
    Common::Accessory AccessorySerializer::FromJson(const boost::json::object &obj)
    {
